...
// -------------------------------------------
// Global pointer for host_input pinned memory
// -------------------------------------------
static const float* g_pinned_host_input = nullptr;


// =====================================================
// Kernel: Unroll one image (Batch logically = 1)
// Produces a matrix of shape [Channel*K*K, H_out*W_out]
// =====================================================
__global__ void matrix_unrolling_kernel(const float *input, float *output,
    ...
    // output: [Channel*K*K, H_out*W_out]
...
// =====================================================
// Kernel: Permute matmul output ()
// Converts from [Map_out, Batch, image_size] to [Batch, Map_out, image_size]
//
...
// =====================================================
// Function: conv_forward_gpu_prolog (Streams version)
// Performs the entire pipeline:
//   1. H2D async copy per image
//   2. Unroll kernel
//   3. Matmul kernel
//   4. Permute kernel
//   5. Overlapped using multiple CUDA streams
// =====================================================
...
// =====================================================
// conv_forward_gpu: intentionally empty
// All streaming work is done inside prolog()
// =====================================================
...
// =====================================================
// Epilog: copy device output back and free memory
// =====================================================
